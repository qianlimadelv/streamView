...
if(NOT result EQUAL 0)
    message(FATAL_ERROR "streamview analyze csv failed: ${stderr}")
endif()
...
if(NOT compare_result EQUAL 0)
    message(FATAL_ERROR "CLI CSV output differs from golden file: ${STREAMVIEW_OUTPUT} != ${STREAMVIEW_GOLDEN}")
endif()
