...
if(DEFINED STREAMVIEW_EXPECTED_FRAME_FIELD)
    string(FIND "${output_json}" "\"${STREAMVIEW_EXPECTED_FRAME_FIELD}\"" frame_field_position)
    if(frame_field_position EQUAL -1)
        message(FATAL_ERROR "Required frame field ${STREAMVIEW_EXPECTED_FRAME_FIELD} was not found in inspect output")
    endif()
endif()
