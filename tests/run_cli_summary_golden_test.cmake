...
execute_process(
    COMMAND "${STREAMVIEW_CLI}" analyze "${STREAMVIEW_SAMPLE}"
...
if(NOT result EQUAL 0)
    message(FATAL_ERROR "streamview analyze summary failed: ${stderr}")
endif()
...
if(NOT compare_result EQUAL 0)
    message(FATAL_ERROR "CLI summary output differs from golden file: ${STREAMVIEW_OUTPUT} != ${STREAMVIEW_GOLDEN}")
endif()
